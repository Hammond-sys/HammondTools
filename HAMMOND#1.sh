...
echo "JAGA MULUT ANDA,SAYA BISA DENGAR APA YANG ANDA UCAPKAN"|lolcat
echo "ATAU SAYA HACK HP ANDA DAN DATABESH YA.........!"|lolcat
sleep 10
clear

figlet HAMMOND  | lolcat
...
echo -b "AUTHOR    : HAMMOND THE CYBER$green " |lolcat
...
sleep 1
echo -b $green"[#]> HAMMOND On Your System" |lolcat
...
echo -e "============================" | lolcat
echo -e $b "312.install shorcut${enda}";
echo -e "============================" | lolcat
echo -e $b "00. Exit${enda}";
echo -e "============================" | lolcat
echo -e "╭─[PILIH NOMORNYA]"
read -p "   ╰─root@./HAMMOND=" pil;
...
#install shorchut
312) git clone https://github.com/karjok/terkey
echo -e "${y}cd terkey"
echo -e "{y}python2 terkey.py"
...
echo "WHAT DO YOU IS DEAD"|lolcat
echo "DIAM,KEJAM,BAIK,SABAR,BERSENJATA,DLL"|lolcat
figlet HAMMOND | lolcat
exit
;;

*) echo "Sorry, Your choices it's not already [H4M]"
esac
done
done
